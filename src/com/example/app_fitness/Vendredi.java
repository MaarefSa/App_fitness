...
public class Vendredi extends Activity {
	
	String id=MainActivity.myId;
	
	String urladdressM=id+"/coach/ex_jour/minceVe.php";
	String urladdressN=id+"/coach/ex_jour/normaleVe.php";
	String urladdressS=id+"/coach/ex_jour/surpoidVe.php";
	String[] titre;
    String[] desc;
    String[] imagepath;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(code.equals("minceVe"))
		{
		listView=(ListView)findViewById(R.id.lview5);
