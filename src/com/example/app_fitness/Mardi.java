...
public class Mardi extends Activity {

	String id=MainActivity.myId;
	
	String urladdressM=id+"/coach/ex_jour/minceMa.php";
	String urladdressN=id+"/coach/ex_jour/normaleMa.php";
	String urladdressS=id+"/coach/ex_jour/surpoidMa.php";
	String[] titre;
    String[] desc;
    String[] imagepath;
...
//JSON
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.mardi, menu);
		return true;
	}
