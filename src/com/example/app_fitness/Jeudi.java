...
public class Jeudi extends Activity {
	
	String id=MainActivity.myId;
	
	String urladdressM=id+"/coach/ex_jour/minceJe.php";
	String urladdressN=id+"/coach/ex_jour/normaleJe.php";
	String urladdressS=id+"/coach/ex_jour/surpoidJe.php";
	String[] titre;
    String[] desc;
    String[] imagepath;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(code.equals("minceJe"))
		{
		listView=(ListView)findViewById(R.id.lview4);
