...
public class Regimt extends Activity {

	String id=MainActivity.myId;
	
	String urladdress=id+"/coach/readRt.php";
    String[] jour;
    String[] desc;
    ListView listViewt;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_regimt);
...
//JSON
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.regimt, menu);
		return true;
	}
