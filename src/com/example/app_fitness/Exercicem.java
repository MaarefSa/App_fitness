...
public class Exercicem extends Activity {

	String id=MainActivity.myId;
	
	 String urladdress=id+"/coach/readEm.php";
	    String[] titre;
	    String[] desc;
	    String[] imagepath;
	    ListView listViewm;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_exercicem);
      ...
      //Tab 1
        ...
        intent = new Intent(Exercicem.this, Lundi.class);
        intent.putExtra("numbers", "normalelu");
      ...
      //Tab 2
        ...
        intent = new Intent(Exercicem.this, Mardi.class);
        intent.putExtra("numbers", "normaleMa");
        ...
        intent = new Intent(Exercicem.this, Mercredi.class);
        intent.putExtra("numbers", "normaleMe");
      ...
      //Tab 4
        ...
        intent = new Intent(Exercicem.this, Jeudi.class);
        intent.putExtra("numbers", "normaleJe");
      ...
      //Tab 5
        ...
        intent = new Intent(Exercicem.this, Vendredi.class);
        intent.putExtra("numbers", "normaleVe");
      ...
      //Tab 6
        ...
        intent = new Intent(Exercicem.this, Samedi.class);
        intent.putExtra("numbers", "normaleSa");
      ...
      //Tab 7
        ...
        intent = new Intent(Exercicem.this, Dimanche.class);
        intent.putExtra("numbers", "normaleDi");
...
*/
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.exercicem, menu);
		return true;
	}
