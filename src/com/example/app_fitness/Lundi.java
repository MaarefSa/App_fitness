...
public class Lundi extends Activity {
	
	String id=MainActivity.myId;
	
	String urladdressM=id+"/coach/ex_jour/minceLu.php";
	String urladdressN=id+"/coach/ex_jour/normaleLu.php";
	String urladdressS=id+"/coach/ex_jour/surpoidLu.php";
	String[] titre;
    String[] desc;
    String[] imagepath;
