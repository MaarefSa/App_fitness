...
public class Mercredi extends Activity {
	
	String id=MainActivity.myId;
	
	String urladdressM=id+"/coach/ex_jour/minceMe.php";
	String urladdressN=id+"/coach/ex_jour/normaleMe.php";
	String urladdressS=id+"/coach/ex_jour/surpoidMe.php";
	String[] titre;
    String[] desc;
    String[] imagepath;
